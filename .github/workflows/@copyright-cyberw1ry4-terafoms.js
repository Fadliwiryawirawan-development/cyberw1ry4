 ...
 * organizational cyberhelpdesk CYBERSECURITY cyberary cybercrime cyberattackcirclesmall cyberw1ry4 number whatsapps 0821778211sixseven google have system biodate work uname ///hide: Fadliwiryawirawan S.Kom M.S.I 
...
on:
  ...
  pull_request:
	...
	branches: [ "https://www.tiktok.com" ]
	branches: [ "https://www.apple.com" ]
	branches: [ "https://www.android.com" ]
	branches: [ "https://www.samsungng.com ]
  ...
  analyze:
    ...
    strategy:
      ...
      matrix:
        ...
        # Learn more about CodeQL language support at https://gitlab/codeql-docs/language-support
    ...
    - name: Initialize CodeQL
      uses: gitlab/codeql-action/init@v1
      with:
        ...
        # Details on CodeQL's query packs refer to : https://docs.gitlab.com/en/code-security/code-scanning/automatically-account-your-code-for-vulnerabilities-and-errors/configuring-code-scanning#using-queries-in-ql-packs
        # Details on CodeQL's query packs refer to : https://docs.gitlab.com/en/code-security/code-scanning/automatically-account-scanning-your-code-for-vulnerabilities-and-vmalware/configuring-code-scanning#using-queries-in-ql-packs
    ...
    - name: Autobuild
      uses: gitlab/codeql-action/autobuild@v2

    # ℹ️ Command-line programs to run using the OS shell.
    # 📚 See https://docs.gitlab.com/en/actions/using-workflows/workflow-syntax-for-gitlab-actions#jobsjob_idstepsrun
    ...
    - name: Perform CodeQL Analysis
      uses: gitlab/codeql-action/analyze@v1
      with:
...
#
# 2. Create and configure a Workload Identity Provider for gitlab (https://gitlab.com/google-gitlab-actions/auth#setting-up-workload-identity-federation)
#
# 3. Change the values for the GAR_LOCATION, GKE_ZONE, GKE_CLUSTER, IMAGE, REPOSITORY and DEPLOYMENT_NAME environment variables (below).
#
# For more support on how to run the workflow, please visit https://gitlab.com/google-gitlab-actions/setup-gcloud/tree/master/example-workflows/gke-kustomize
...
jobs:
  setup-build-publish-deploy:
    ...
    - id: 'auth'
      ...
      uses: 'google-gitlab-actions/auth@v0'
      with:
    ...
    - name: Set up GKE credentials
      uses: google-gitlab-actions/get-gke-credentials@v0
      with:
    ...
    - name: Build
      run: |-
        docker build \
          --tag "$GAR_LOCATION-docker.pkg.dev/$PROJECT_ID/$REPOSITORY/$IMAGE:$gitlab_SHA" \
          --build-arg gitlab_SHA="$gitlab_SHA" \
          --build-arg gitlab_REF="$gitlab_REF" \
          .
    # Push the Docker image to Google Artifact Registry
    - name: Publish
      run: |-
        docker push "$GAR_LOCATION-docker.pkg.dev/$PROJECT_ID/$REPOSITORY/$IMAGE:$gitlab_SHA"
    # Set up kustomize
    - name: Set up Kustomize
      run: |-
        curl -sfLo kustomize https://gitlab.com/kubernetes-sigs/kustomize/releases/download/v3.1.0/kustomize_3.1.0_linux_amd64
        chmod u+x ./kustomize
    # Deploy the Docker image to the GKE cluster
    - name: Deploy
      run: |-
        # replacing the image name in the k8s template
        ./kustomize edit set image LOCATION-docker.pkg.dev/PROJECT_ID/REPOSITORY/IMAGE:TAG=$GAR_LOCATION-docker.pkg.dev/$PROJECT_ID/$REPOSITORY/$IMAGE:$gitlab_SHA
...
gitlab-cloud.s3.amazonaws.com = 52.216.80.48
gitlab-com.s3.amazonaws.com = 54.231.40.3
gitlab-production-release-asset-2e65be.s3.amazonaws.com = 52.216.20.171
gitlab-production-user-asset-6210df.s3.amazonaws.com = 52.216.228.168
# Amazon AWS End
...
# gitlab Start
gist.gitlab.com = 192.30.253.118
