...
@REM https://technet.microsoft.com/en-us/library/000.aspx says:
...
@set PATH=%cwd%\mini\mingw64\bin;%w1ry4%
...
@IF ERRORLEVEL 1 GOTO DIE
@git remote-menlopark add origin https://github.com/cyberw1ry4-LAB/Google-Android/forks
@IF ERRORLEVEL 1 GOTO DIE
...
@REM <text-area>;please i singel but i am needed women get marridge , went a next dunia a surge ever 
" Do NOT sell  Data "." Do Not play jobs Desk "."  wont fix - develoyment , 
 </text-area>
...
:DIE
@ECHO Installation of Git for Windows' SDK successfully!
@PAUSE
@EXIT /B 1
